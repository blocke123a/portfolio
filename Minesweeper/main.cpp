...
int main()
{
    ...
    string boardFile = "files/board_config.cfg";
    Board gameBoard(boardFile);

    sf::Font temp;
    temp.loadFromFile("files/font.ttf");
...
vector<sf::Sprite> Digits() {
    ...
    sf::Sprite digit0(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit1(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit2(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit3(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit4(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit5(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit6(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit7(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit8(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digit9(TextureManage::GetTexture("files/images/digits"));
    sf::Sprite digitNeg(TextureManage::GetTexture("files/images/digits"));
...
unordered_map<string, sf::Sprite> Sprites() {
    ...
    sf::Sprite happyFaceSprite(TextureManage::GetTexture("files/images/face_happy"));
    sf::Sprite deadFaceSprite(TextureManage::GetTexture("files/images/face_lose"));
    sf::Sprite winFaceSprite(TextureManage::GetTexture("files/images/face_win"));
    sf::Sprite debugSprite(TextureManage::GetTexture("files/images/debug"));
    sf::Sprite playSprite(TextureManage::GetTexture("files/images/play"));
    sf::Sprite pauseSprite(TextureManage::GetTexture("files/images/pause"));
    sf::Sprite leaderboardSprite(TextureManage::GetTexture("files/images/leaderboard"));
...
unordered_map<string, vector<vector<sf::Sprite>>> GetSpriteVect(Board board) {
    ...
    sf::Sprite flagSprite(TextureManage::GetTexture("files/images/flag"));
    sf::Sprite mineSprite(TextureManage::GetTexture("files/images/mine"));
    sf::Sprite num1Sprite(TextureManage::GetTexture("files/images/number_1"));
    sf::Sprite num2Sprite(TextureManage::GetTexture("files/images/number_2"));
    sf::Sprite num3Sprite(TextureManage::GetTexture("files/images/number_3"));
    sf::Sprite num4Sprite(TextureManage::GetTexture("files/images/number_4"));
    sf::Sprite num5Sprite(TextureManage::GetTexture("files/images/number_5"));
    sf::Sprite num6Sprite(TextureManage::GetTexture("files/images/number_6"));
    sf::Sprite num7Sprite(TextureManage::GetTexture("files/images/number_7"));
    sf::Sprite num8Sprite(TextureManage::GetTexture("files/images/number_8"));
    sf::Sprite hiddenTileSprite(TextureManage::GetTexture("files/images/tile_hidden"));
    sf::Sprite revealedTileSprite(TextureManage::GetTexture("files/images/tile_revealed"));
